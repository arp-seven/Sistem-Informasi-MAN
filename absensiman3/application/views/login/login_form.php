...
<body class="animsition">
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                                <img src="<?php echo base_url();?>asset/images/icon/logo-absensi.png" alt="MAN3LEBAK">
                            </a>
                        </div>
	...
	?>
    <form action="<?php echo base_url();?>absensiman3/login" method="post" accept-charset="utf-8" name="login_form" id="login_form" autocomplete="off"
