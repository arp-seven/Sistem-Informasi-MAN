<footer class="footer">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <img width="150" src="<?php echo base_url('');?>style/img/man2.png" class="rounded" alt="MAN3LEBAK">
                        </div>
                    </div>
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> <a href="https://Man3lebak.Mysch.id/" target="_blank">MAN 3 Lebak</a> </p>
                        </p>
                    </div>
                </div>
            </div>
