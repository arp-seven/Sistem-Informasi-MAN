...
<div class="slider_area">
      ...
      <div class="man-slider">
                <div class="isi-slider">
                    ...
                    <img src="style/img/bg3.jpg">
                    
                    <!-- <img src="style/img/bg3.jpg">
                    <img src="style/img/bg4.jpg">
                    <img src="style/img/bg5.jpg"> -->
                       <div class="row">
                        <div class="col-xl-12">
                             <div class="slider_text ">
                                <h1 class="text-center front text-white">MAN 3 LEBAK </h1>
                                <h2 class="text-center front text-white">IMTAQ IMTEQ AHLAKUL KARIMAH </h2>
                            </div>
                        </div>
                    </div>
                </div>
